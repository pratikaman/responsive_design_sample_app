...
import 'package:responsive_design_sample_app/flow/res/custom_colors.dart';
import 'package:responsive_design_sample_app/flow/widgets/text_view.dart';

class MenuWidget extends StatefulWidget {
  final int selectedIndex;
  final Function(int selectedIndex) onTapped;

  MenuWidget({super.key, required this.onTapped, required this.selectedIndex});
